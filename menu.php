	...
	if(!isset($_SESSION['connexion'])){
				...
				include 'header.php';
	 			...
	 			if(!isset($_SESSION['connexion'])){
					...
					{?>
						<FORM>
							<INPUT TYPE="button" NAME="Refugies" VALUE="ACCÉDEZ A LA GESTION DU PERSONNEL">
						</FORM>
						<?php
					}elseif ($_SESSION['Role'] == 'Personnel administratif') {?>
						<FORM>
							<INPUT TYPE="button" NAME="Refugies" VALUE="ACCÉDEZ A LA GESTION DES RÉFUGIÉS DE VOTRE CAMP">
						</FORM>
						<?php
					}elseif ($_SESSION['Role'] == 'Gestionnaire Camp') {?>
						<FORM>
							<INPUT TYPE="button" NAME="Refugies" VALUE="ACCÉDEZ A LA GESTION DU STOCK DE VOTRE CAMP">
						</FORM>
						<?php
					}elseif ($_SESSION['Role'] == 'Gestionnaire centrale') {?>
						<FORM>

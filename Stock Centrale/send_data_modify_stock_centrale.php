...
$stmt = $pdo->prepare("UPDATE quantitecentrale Set AlerteQtCentrale=:AlerteQtCentrale, QtCentrale = :QtCentrale, QuantiteMax=:QuantiteMax WHERE IdCentrale=:IdCentrale and IdMateriel = :IdMateriel");
